...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, HX711_SCK_Pin|DS1302_RST_Pin|DS1302_DAT_Pin|DS1302_CLK_Pin
  ...
  /*Configure GPIO pins : HX711_SCK_Pin DS1302_RST_Pin DS1302_DAT_Pin DS1302_CLK_Pin
                           LED_Pin */
  GPIO_InitStruct.Pin = HX711_SCK_Pin|DS1302_RST_Pin|DS1302_DAT_Pin|DS1302_CLK_Pin
                          |LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
